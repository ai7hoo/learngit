...
<div id="nr_ac"> 
    ...
    <ul style="background-image: url(&quot;images/nr_ac_home_diy_switch_2_3_1.jpg&quot;);" class="main" data-background="images/nr_ac_home_diy_switch_2_3_1.jpg">
          <li class="active">
        <h1>个性定制 DIY</h1>
        <div>
              <h3 class="title">3室1厅</h3>
              <img src="" alt="">
              <div class="areaForm" id="jsAreaForm">
            <h4>请输入房间使用面积</h4>
            <div tabindex="0" style="overflow: hidden; padding: 0px; width: 254px;" class="section jspScrollable">
                  <div style="width: 254px; height: 400px;" class="jspContainer">
                <div style="padding: 0px; width: 243px; top: 0px;" class="jspPane">
                    ...
                    <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all">
                      ...
                      <div class="ctrlSetter" id="js_cw1Setter">
                    <div class="line-ctrl" data="xk"></div>
                    <div class="remote-ctrl good active" data="yk"></div>
                  </div>
        <!----              <div class="areaSetter">
        ...
        <div class="btn-group"> <a href="show.asp" class="return">〈　　返回</a> <a class="next" data="validate">下一步　　〉</a> </div>
        <ul class="step">
              <li><a>1</a></li>
          ...
          <li style="background-image: url(&quot;images/nr_ac_home_diy_switch_2_3_1.jpg&quot;);" data-background="images/nr_ac_home_diy_switch_2_3_1.jpg">
        <h1>个性定制 DIY</h1>
        <div>
        ...
        <div class="final">
            ...
            <li>
                ...
                <li>
                    ...
                    <p>本案是一套空调使用面积为<span id="plan1_areaSize"></span>平米三室一厅的户型，内机台数为<span id="plan1_njNum"></span>台，外机台数为<span id="plan1_wjNum"></span>台，总负荷为<span id="plan1_fh"></span>W的多联式家庭中央空调设计方案</p>
            ...
            <li>
                ...
                <li>
                    ...
                    <p>本案是一套空调使用面积为<span id="plan2_areaSize"></span>平米三室一厅的户型，内机台数为<span id="plan2_njNum"></span>台，外机台数为<span id="plan2_wjNum"></span>台，总负荷为<span id="plan2_fh"></span>W的多联式家庭中央空调设计方案</p>
                    <img id="fentiImg" src="images/P020131218565040948531_350.jpg"> </div>
                    </li>
                <li class="blue">
                      <h3>三室一厅</h3>
                      <div class="scroll">
