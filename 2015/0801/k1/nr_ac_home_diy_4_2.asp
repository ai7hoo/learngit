...
<div id="nr_ac"> 
   ...
   <!-- START 主体 -->
    <div class="nr_ac_home_diy">
      <ul style="background-image: url(&quot;images/nr_ac_home_diy_switch_2_4_2.jpg&quot;);" class="main" data-background="images/nr_ac_home_diy_switch_2_4_2.jpg">
        <li class="active">
          <h1>个性定制 DIY</h1>
          <div>
            <h3 class="title">4室2厅</h3>
            ...
            <div class="areaForm" id="jsAreaForm">
              ...
              <div style="width: 254px; height: 400px;" class="jspContainer"><div style="padding: 0px; width: 243px; top: 0px;" class="jspPane"><div class="areaSetter">
                ...
                <div class="ctrlSetter" id="js_cw3Setter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div></div><div class="jspVerticalBar"><div class="jspCap jspCapTop"></div><a class="jspArrow jspArrowUp jspDisabled"></a><div style="height: 370px;" class="jspTrack"><div style="height: 154px;" class="jspDrag"><div class="jspDragTop"></div><div class="jspDragBottom"></div></div></div><a class="jspArrow jspArrowDown"></a><div class="jspCap jspCapBottom"></div></div></div></div>
            </div>
			<div class="line-tips">
		...
		<li style="background-image: url(&quot;images/nr_ac_home_diy_switch_2_4_2.jpg&quot;);" data-background="images/nr_ac_home_diy_switch_2_4_2.jpg">
          <h1>个性定制 DIY</h1>
          <div>
              ...
              <div class="accessories">
                ...
                <ul class="accessories-contents">
                  ...
                  <li class="selector">
                    ...
                    <div class="tips">
                      <img src="images/nr_ac_home_diy_step3_tips1.jpg">
                    </div>
                  </li>
                  <li class="selector">
                ...
                <ul>
                  <li>
                    ...
                    <div class="scroll" id="plan_productlist1">
                      <p>本案是一套空调使用面积为<span id="plan1_areaSize"></span>平米四室两厅的户型，内机台数为<span id="plan1_njNum"></span>台，外机台数为<span id="plan1_wjNum"></span>台，总负荷为<span id="plan1_fh"></span>W的多联式家庭中央空调设计方案</p>
                ...
                <ul>
                  <li>
                    ...
                    <div class="scroll" id="plan_productlist2">
                      <p>本案是一套空调使用面积为<span id="plan2_areaSize"></span>平米四室两厅的户型，内机台数为<span id="plan2_njNum"></span>台，外机台数为<span id="plan2_wjNum"></span>台，总负荷为<span id="plan2_fh"></span>W的多联式家庭中央空调设计方案</p>
