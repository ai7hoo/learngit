...
<div id="nr_ac"> 
    ...
    <div class="nr_ac_home_diy">
      <ul style="background-image: url(&quot;images/nr_ac_home_diy_switch_2_5_2.jpg&quot;);" class="main" data-background="images/nr_ac_home_diy_switch_2_5_2.jpg">
        <li class="active">
          <h1><span></span>个性定制 DIY</h1>
          <div>
            <h3 class="title">5室2厅</h3>
            <div class="areaForm" id="jsAreaForm">
              <h4>请输入房间使用面积</h4>
              <div tabindex="0" style="overflow: hidden; padding: 0px; width: 254px;" class="section jspScrollable">
			
              <div style="width: 254px; height: 400px;" class="jspContainer"><div style="padding: 0px; width: 243px; top: 0px;" class="jspPane"><div class="areaSetter">
                  <div class="input">
                    <label>客厅</label>
                    <input value="0" id="js_kt" type="text">
                  </div>
                  <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
                </div><div class="ctrlSetter" id="js_ktSetter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div><div class="areaSetter">
                  <div class="input">
                    <label>餐厅</label>
                    <input value="0" id="js_ct" type="text">
                  </div>
                  <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
                </div><div class="ctrlSetter" id="js_ctSetter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div><div class="areaSetter">
                  <div class="input">
                    <label>主卧</label>
                    <input value="0" id="js_zw" type="text">
                  </div>
                  <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
                </div><div class="ctrlSetter" id="js_zwSetter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div>
                ...
                <div class="areaSetter">
                  <div class="input">
                    <label>次卧</label>
                    <input value="0" id="js_cw1" type="text">
                  </div>
                  <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
                </div><div class="ctrlSetter" id="js_cw1Setter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div><div class="areaSetter">
                  <div class="input">
                    <label>次卧</label>
                    <input value="0" id="js_cw2" type="text">
                  </div>
                  <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
                </div><div class="ctrlSetter" id="js_cw2Setter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div><div class="areaSetter">
                  <div class="input">
                    <label>次卧</label>
                    <input value="0" id="js_cw3" type="text">
                  </div>
                  <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
                </div><div class="ctrlSetter" id="js_cw3Setter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div><div class="areaSetter">
                  <div class="input">
                    <label>次卧</label>
                    <input value="0" id="js_cw4" type="text">
                  </div>
                  <div class="slider ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
                </div>
                
                -->
                <div class="ctrlSetter" id="js_cw4Setter">
                  <div class="line-ctrl" data="xk"></div>
                  <div class="remote-ctrl good active" data="yk"></div>
                </div></div><div class="jspVerticalBar"><div class="jspCap jspCapTop"></div><a class="jspArrow jspArrowUp jspDisabled"></a><div style="height: 370px;" class="jspTrack"><div style="height: 132px;" class="jspDrag"><div class="jspDragTop"></div><div class="jspDragBottom"></div></div></div><a class="jspArrow jspArrowDown"></a><div class="jspCap jspCapBottom"></div></div></div></div>
            </div>
            <div class="line-tips">
              <img src="images/nr_ac_home_diy_line_ctrl_text.jpg" alt="">
            </div>
            <div class="remote-tips">
              <img src="images/nr_ac_home_diy_remote_ctrl_text.jpg" alt="">
            </div>
          </div>
          <div class="btn-group">
            <a href="http://www.haier.com/cn/business/central_air_conditioning/air_conditioning_system/Customize.shtml" class="return">〈　　　　返回</a>
            <a class="next" data="validate">下一步　　　〉</a>
          </div>
          <ul class="step">
            <li><a>1</a></li>
		...
		<li style="background-image: url(&quot;images/nr_ac_home_diy_switch_2_2_2.jpg&quot;);" data-background="images/nr_ac_home_diy_switch_2_2_2.jpg">
          <h1>个性定制 DIY</h1>
          <div>
              ...
              <div class="accessories">
                ...
                <ul class="accessories-contents">
                  <li class="selector">
                    ...
                    <div class="contents-image part"><img src="images/nr_ac_home_diy_step3_item_1.jpg" class="active"><img src="5_2_files/nr_ac_home_diy_step3_item_1_normal.jpg" class="normal"></div>
                    <div class="contents-sub-selector"><div class="nr_ac_radio"></div></div>
                  </li>
                  <li class="selector">
                    <div class="contents-title">3D面板</div>
                    <div class="contents-image"><img src="images/nr_ac_home_diy_step3_item_2.jpg"></div>
                    <div class="contents-sub-selector checked" data="3d"><div class="nr_ac_radio"></div></div>
                    <div class="tips">
                      <img src="images/nr_ac_home_diy_step3_tips1.png">
                    </div>
                  </li>
                  <li class="selector">
                    <div class="contents-title">普通面板</div>
                    <div class="contents-image"><img src="images/nr_ac_home_diy_step3_item_3_gray.jpg"></div>
                    <div class="contents-sub-selector" data="normal"><div class="nr_ac_radio"></div></div>
                    <div class="tips">
                      <img src="images/nr_ac_home_diy_step3_tips2.jpg">
                    </div>
                  </li>
                </ul>
              </div>
              <div class="voltage">
                ...
                <ul class="voltage-contents">
                  <li class="selector">
                    ...
                    <div class="contents-sub-selector checked" data="220v"><div class="nr_ac_radio"></div></div>
                  </li>
                  <li class="selector">
                    <div class="contents-image"><img src="images/nr_ac_home_diy_step3_item_5_gray.jpg"></div>
                    <div class="contents-sub-selector" data="380v"><div class="nr_ac_radio"></div></div>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="btn-group">
            <a class="return">〈　　　　返回</a>
            <a class="next" id="finalNext">下一步　　　〉</a>
          </div>
          <ul class="step">
            <li><a>1</a></li>
            <li><a>2</a></li>
                  ...
                  <li>
                    <h3>多联式家庭中央空调</h3>
                     <div class="scroll" id="plan_productlist1">
                      <p>本案是一套空调使用面积为<span id="plan1_areaSize"></span>平米五室两厅的户型，内机台数为<span id="plan1_njNum"></span>台，外机台数为<span id="plan1_wjNum"></span>台，总负荷为<span id="plan1_fh"></span>W的多联式家庭中央空调设计方案</p>
                      <img id="duolianImg" src="images/LEKA36BC6.jpg">
...
<form action="" method="post" id="myform2">
                ...
                <ul>
                  <li>
                    ...
                    <div class="scroll" id="plan_productlist2">
                      <p>本案是一套空调使用面积为<span id="plan2_areaSize"></span>平米五室两厅的户型，内机台数为<span id="plan2_njNum"></span>台，外机台数为<span id="plan2_wjNum"></span>台，总负荷为<span id="plan2_fh"></span>W的多联式家庭中央空调设计方案</p>
                      <img id="fentiImg" src="images/P020131218565040948531_350.jpg">
            ...
            <a class="return"><span>〈</span>　　　返回</a>
          </div>
          <ul class="step">
            <li><a>1</a></li>
            <li><a>2</a></li>
            <li><a>3</a></li>
            <li class="last active"><a style="color:white;">4</a></li>
          </ul>
        </li>
      </ul>
    </div>
