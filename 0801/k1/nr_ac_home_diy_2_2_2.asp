...
<div id="nr_ac"> 
      ...
      <!-- START 主体 -->
  <div class="nr_ac_home_diy" style=" background:url(images/nr_ac_home_diy_bg_empty.jpg) repeat-x; width:100%;">
      <div class="main">
        <div class="diy_bac_2_2" style=" background:url(images/diy2_2.jpg) no-repeat top center; height:650px; overflow:hidden; position:relative;">
         	<div id="selecte_btn">
                <div class="selecte_btn_1 f_l">
                	按面房间面积选型
                </div>
                <div class="selecte_btn_1 f_r">
                	按空调匹数选型
                </div>
            </div>  
        </div>
        
        <div class="btn-group"> <a href="show.asp" class="return">〈　　　　返回</a> <a class="next" id="houseAreaNext" data="validate">下一步　　　〉</a> 
        </div>
    </div>
  </div>
      <!-- END 主体 --> 
