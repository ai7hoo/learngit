...
<div id="nr_width_control" class="js_nr_width_control"> 
  ...
  <div id="nr_body">
    <div class="nr_content"> 
      ...
      <div id="nr_ac" class="customer_content"> 
        ...
        <div class="customer_box">
        	<div class="pic_title">
                ...
                <div class="check_box">
                    ...
                    <input class="message_text" id="model" type="text" placeholder="型号">
                    <input class="message_text" id="Brand" type="text" placeholder="品牌">
                    
                    <div class="subbtn"> <a href="#">查 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;询</a> </div>
