...
var Boys = React.createClass({displayName: "Boys",
    render: function(){
        return React.createElement("h4", {className: "nihao", style: {width:this.props.width}}, "name: ", this.props.name)
    }
});
React.render(
    React.createElement(Boys, {name: "quinn", width: "500", cName: "redBox"}),
